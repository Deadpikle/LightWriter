<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LightWriter.WebForm1" %>
...
<head runat="server">
    ...
    <script src="Scripts/Plugins/jquery-ui-1.10.3.min.js"></script>

    <script type="text/javascript" src="Scripts/GUI.js"></script>
    <script type="text/javascript" src="Scripts/functionsAndClasses.js"></script>
	<script type="text/javascript" src="Scripts/index.js"></script>
    <script type="text/javascript" src="Scripts/ajaxServicesAndDialogs.js"></script-->

    <!--link rel="stylesheet" type="text/css" href="Content/themes/css/LightWriterTheme/jquery-ui-1.10.3.custom.css" />
    <link rel="stylesheet" type="text/css" href="Content/index.css" />
    <link rel="stylesheet" type="text/css" href="Content/GUI.css" /-->
    <%= Bundle.Css()
        .Add("~/Content/themes/css/LightWriterTheme/jquery-ui-1.10.3.custom.css")
        .Add("~/Content/index.css")
        .Add("~/Content/GUI.css")
        //.ForceRelease()
        .Render("~/Content/LightWriter_Combined_#.css")
    %>
    <%= Bundle.JavaScript()
        .Add("~/Scripts/Plugins/jquery-1.10.2.js")
        .Add("~/Scripts/Plugins/jquery-ui-1.10.3.min.js")
        .Add("~/Scripts/Plugins/Procolor/prototype.js")
        .Add("~/Scripts/Plugins/Procolor/procolor.js")
        //.Add("~/Scripts/Plugins/Procolor/procolor.compressed.js")
        .Add("~/Scripts/Plugins/ColorMixer/jquery.color.2.1.2.min.js")
        .Add("~/Scripts/Plugins/ColorMixer/color_mixer.js")
        .Add("~/Scripts/GUI.js")
        .Add("~/Scripts/functionsAndClasses.js")
        .Add("~/Scripts/index.js")
        .Add("~/Scripts/ajaxServicesAndDialogs.js")
        //.ForceRelease()
        .Render("~/Scripts/LightWriter_Combined_#.js")
    %>
</head>
<body>
    <div id="PageDiv">
        <div id="ToolsDiv">
            <div id="ToolsTitle" class="title">
                <div class="TitleTextOffset">
                    <img src="Content/images/BlocksBanner.png" alt="Blocks"/>
                </div>
            </div>
            <div id="ToolsAccordion">
                ...
                <div> <!-- TODO: Remove onclick calls and add them as an event handler in the js via .on() [seperate GUI & logic] -->
                    <div id="SingleDraggable" class="DraggableBlock">
                        <div><img src="Content/images/SingleIcon.png" alt="Single"/></div>
                        <label>Single</label>
                    </div>
                    <div id="ComparisonDraggable" class="DraggableBlock">
                        <div><img src="Content/images/ComparisonIcon.png" alt="Comparison"/></div>
                        <label>Comparison</label>
                    </div>
                    <div id="RangeDraggable" class="DraggableBlock">
                        <div><img src="Content/images/RangeIcon.png" alt="Range"/></div>
                        <label>Range</label>
                    </div>
                    <div id="CircleDraggable" class="DraggableBlock">
                        <div><img src="Content/images/CircleIcon.png" alt="Circle"/></div>
                        <label>Circle</label>
                    </div>
                </div>
                ...
                <div>
                    <div id="SingleMoveDraggable" class="DraggableBlock">
                        <div><img src="Content/images/SingleMove.gif" alt="Single Move"/></div>
                        <label>Single Move</label>
                    </div>
                    <div id="ComparisonMoveDraggable" class="DraggableBlock">
                        <div><img src="Content/images/ComparisonMove.gif" alt="Comparison Move"/></div>
                        <label>Comparison Move</label>
                    </div>
                    <div id="RangeMoveDraggable" class="DraggableBlock">
                        <div><img src="Content/images/RangeMove.gif" alt="Range Move"/></div>
                ...
                <div>
                    <div id="CommentDraggable" class="DraggableBlock">
                        <div><img src="Content/images/CommentIcon.png" alt="Comment"/></div>
                        <label>Comment</label>
                    </div>
                </div>
            </div>
        ...
        <div id="CodeDiv">
            <div id="CodeTitle" class="title">
                <div class="TitleTextOffset"><img src="Content/images/PatternBanner.png" alt="Your Pattern"/></div>
            </div>
            <div id="ActualCode">
                <ul id="block-list">
                </ul> 
        ...
        <div id="RightHalf">
            <div id="MenuBar">
                <div id="MenuBanner"><img src="Content/images/MenuBanner.png" alt="Menu"/></div>
			    <div id="MenuButtons">
                    <input type="image" onclick=" return StartStopToggle()" class="menuButton StartStopButton" src="Content/images/StartButton.png"/>
                    <input type="image" onclick=" return false" class="menuButton saveAlgorithmButton" 
                        src="Content/images/SaveButton.png"/>
                    <input type="image" onclick=" return false" class="menuButton loadAlgorithmButton" 
                        src="Content/images/LoadButton.png"/>
                    <input type="image" onclick=" return EnterPresentationMode()" class="menuButton" src="Content/images/PresentButton.png"/>
                    <input type="image" id="rules-button" class="menuButton" src="Content/images/RulesButton.png"/>
                    <input type="image" onclick=" return requestFullScreen()" class="menuButton" src="Content/images/FullButton.png"/>
                    <input id="menuLoginButton" type="image" class="menuButton loginButton" 
                            runat="server" src="Content/images/LoginButton.png"/>
                    <img class="busy-spinner" id="menu-busy-spinner" src="Content/images/ajax-loader-menu.gif" />
			    </div>
            </div>
            <div id="LightGrid">
            ...
            <div id="PresentationMenu">
			    <div id="PresentationButtons">
                    <input type="image" onclick=" return StartStopToggle()" class="presentationButton StartStopButton" src="Content/images/StartButton.png"/>
                    ...
                    <input type="image" onclick=" return false" class="presentationButton loadAlgorithmButton" 
                        src="Content/images/LoadButton.png"/>
                    <input type="image" id="shareButton" class="presentationButton" src="Content/images/ShareButton.png"/>
                    <input type="image" onclick=" return ExitPresentationMode()" class="presentationButton" src="Content/images/EditorButton.png"/>
                    <input type="image" onclick=" return requestFullScreen()" class="presentationButton" src="Content/images/PresentationFullButton.png"/>
                    <input id="presentationLoginButton" type="image" class="presentationButton loginButton" 
                            runat="server" src="Content/images/PresentationLoginButton.png"/>
                    <br />
                    <img class="busy-spinner" id="present-busy-spinner" src="Content/images/ajax-loader-share.gif" />
			    </div>
            </div>
        </div>        
    </div>
    ...
    <div class="hidden templates"> <!-- TODO: get this in its own file somehow -->
