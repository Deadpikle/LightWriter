...
function StartStopToggle() {
    if (StartStopState == "start") {    // If button currently displays "start"
        ...
        $(".StartStopButton").attr("src", 'Content/images/StopButton.png'); // Update image
        ...
        $(".StartStopButton").attr("src", 'Content/images/StartButton.png'); // Update image
...
function LoginLogoutHandler(StateIn) {
    ...
    if (LoginLogoutState == "login") {      // If button currently displays "login"
        $("#menuLoginButton").attr("src", 'Content/images/LogoutButton.png'); // Change image in editor
        $("#presentationLoginButton").attr("src", 'Content/images/PresentationLogoutButton.png'); // Change image in presentaiton view
        LoginLogoutState = "logout";        // Update state variable
    }
    else if (LoginLogoutState == "logout") {    // If button currently displays "logout"s
        $("#menuLoginButton").attr("src", 'Content/images/LoginButton.png'); // Change image in editor
        $("#presentationLoginButton").attr("src", 'Content/images/PresentationLoginButton.png'); // Change image in presentation views
